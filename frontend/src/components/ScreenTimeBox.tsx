...
export const ScreenTimeBox: React.FC<ScreenTimeBoxProps> = ({
  ...
  return (
    <div className={`p-4 rounded-xl shadow-md ${bgColor} text-white min-h-[120px] flex flex-col justify-between`}>
      ...
      {showInput ? (
        <div className="space-y-2">
          <input
            ...
            className="w-full p-2 rounded text-black text-center"
          />
          <div className="flex space-x-2">
            <button
              onClick={handleUpdate}
              className="flex-1 bg-white bg-opacity-20 py-1 rounded text-xs"
            >
              Save
            </button>
            <button
